...
/**
 * 
 * @param amount Amount of the transaction:   * `Negative number (< 0)` is a withdrawal   * `Positive number (> 0)` is a deposit 
 * @param addresses Address(es) involved:   * `payments` address(es) where payment was received   * `withdrawals` address(es) where funds were sent 
 * @param timestamp Timestamp of the transaction expressed in `Unix Timestamp`
 */
...
data class WalletTransaction (
    ...
    @Json(name = "addresses")
    val addresses: kotlin.Array<AddressDetail>? = null,
