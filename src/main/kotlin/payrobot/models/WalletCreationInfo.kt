 ...
 * @param walletPassphrase Passphrase required to authorize send funds from your wallet
 * @param error `true` is there was a problem. `false` if not 
 */

data class WalletCreationInfo (
    @Json(name = "currency")
    ...
    @Json(name = "walletPassphrase")
    val walletPassphrase: kotlin.String? = null,
